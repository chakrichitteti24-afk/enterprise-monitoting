  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white/85 backdrop-blur-xl p-5 md:p-6 rounded-3xl border border-slate-200/80 shadow-xs">
        <div className="min-w-0">
          ...
          <p className="text-xs md:text-sm text-slate-500 mt-1 flex items-center gap-2 flex-wrap">
            <span>Roll No: <strong className="font-mono text-slate-700">{student.rollNo}</strong></span>
            <span>•</span>
            <span>Assigned to <strong className="text-slate-800">{student.teamNumber}</strong></span>
            <span>•</span>
            <span>Mentor: <strong className="text-slate-800">{student.mentorName}</strong></span>
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
        ...
        {/* 5. Topics Card (Spans 2 cols on lg) */}
        <BentoCard
        ...
        {/* 6. Activity Card (Spans 2 cols on lg) */}
        <BentoCard
